...
# Read the wild fire data into pandas dataframe
...
app.layout = html.Div(childre = [html.H1 ('Australia Wildfire Dashboard', style={'textAlign': 'center', 'color':'#503D36', 'font-size':26}),
